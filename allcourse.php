...
<a href="allcourse.php"> <button class=menuactive>Courses</button></a><br />
<a href="logout2.php"> <button class=menubutton>Logout</button></a><br />
</div>
<div class="allass">
<table border="1" class="table"><tr>
<td>S/N</td><td>COURSE TITLE</td><td>COURSE CODE</td><td>LEVEL</td><td>ACTION</td></tr>
<?php
            session_start();
    ...
    echo"<tr><td>".$f4['id']."</td><td>".$f4['coursetitle']."</td><td>".$f4['coursecode']."</td><td>".$f4['level']."</td>
	<td><a href=deletecourse.php?details=$f4[id] onclick=\"return confirm('YOU MEAN TO DELETE')\";><img src=image/decline.jpg></a></td></tr>";
    $sel2=$sel2-1;
            }
        ?>
