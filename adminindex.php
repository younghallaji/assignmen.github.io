...
<button onclick="document.getElementById('id01') .style.display='block'" class="adminlogin">Login</button>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="adminlogin.php" method="POST">
    <div class="imgcontainer">
      ...
      <img src="image/adminlogin.jpg" alt="Avatar" class="avatar">
    </div>

    <div class="contain">
      <label><b>Username</b></label>
      <input type="text" placeholder="Enter Username" class="logininput" required="required" name="uname">

      <label><b>Password</b></label>
      <input type="password" placeholder="Enter Password" class="logininput" required="required" name="pass">
