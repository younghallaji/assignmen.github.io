...
<a href="allstudent.php"> <button class=menuactive>Students</button></a><br />
...
<td>S/N</td><td>MATRIC NO</td><td>FIRST NAME</td><td>OTHER NAME</td><td>SURNAME</td><td>LEVEL</td>
<td>E-MAIL</td><td>PASSWORD</td><td>ACTION</td></tr>
<?php
            session_start();
    ...
    echo"<tr><td>".$f4['id']."</td><td>".$f4['matricno']."</td><td>".$f4['firstname']."</td><td>".$f4['othername']."</td>
	<td>".$f4['surname']."</td><td>".$f4['level']."</td><td>".$f4['email']."</td><td>".$f4['password']."</td>
	<td><a href=deletestd.php?details=$f4[id] onclick=\"return confirm('YOU MEAN TO DELETE')\";><img src=image/decline.jpg></td></tr>";
    $sel2=$sel2-1;
            }
        ?>
</table>
