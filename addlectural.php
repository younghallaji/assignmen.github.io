...
<a href="addlectural.php"> <button class=menuactive>Add Lectural</button></a><br />
...
<form method="POST" action="lecturalreg.php">
<div class="list">
<select name="title">
...
&nbsp&nbsp&nbsp&nbsp;
<input type="text" placeholder="SURNAME" required="required" name="surname" /><br /><br /><br /><br />
<input type="text" placeholder="FIRST NAME"  required="required" name="firstname" />&nbsp&nbsp;
<input type="text" placeholder="OTHER NAME"  required="required" name="othername" /><br /><br /><br /><br />
<input type="text" placeholder="PHONE NUMBER"  required="required" name="phonenumber" />&nbsp&nbsp;
<input type="email" placeholder="E-MAIL"  required="required" name="email" /><br /><br /><br /><br />
